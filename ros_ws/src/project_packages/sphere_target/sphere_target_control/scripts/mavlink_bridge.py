...
class sphere_target_mavlink():
    ...
    def arm_disarm_vehicle(self,arm):
        ...
        if arm == 0:
            ...
            print("sphere_target Disarmed!")
        elif arm == 1:
            print("Waiting for the vehicle to arm")
            self.master.motors_armed_wait()
            print('sphere_target Armed!')
...
if __name__ == '__main__':
    sphere_target = sphere_target_mavlink()
    #sphere_target.set_servo_pwm(1,1700)
    #sphere_target.arm_disarm_vehicle(1)
    
    for us in range(1100, 1900, 50):
        sphere_target.set_servo_pwm(1, us)
        time.sleep(0.125)
        print("set pwm:",us)
    
    #sphere_target.request_parameter()
    #sphere_target.arm_disarm_vehicle(0)
